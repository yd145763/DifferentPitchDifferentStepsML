...
folder_path = '/home/grouptan/Documents/yudian/data/linebyline1092singlepitchtrainingreducedlengthSteps'+str(steps)  # Replace with the desired path
...
df_result.to_csv(folder_path+'/df_result_step'+str(steps)+'.csv')
df_pred.to_csv(folder_path+'/df_pred_step'+str(steps)+'.csv')
df_actual.to_csv(folder_path+'/df_actual_step'+str(steps)+'.csv')
df_training.to_csv(folder_path+'/df_training_step'+str(steps)+'.csv')
df_validation.to_csv(folder_path+'/df_validation_step'+str(steps)+'.csv')
